...
2026-04-29 再次触发：启动 v0.5 Phase 4 前核查发现 `ProjectManager/Plan/v0.5/phases/phase-4.md` 尚不存在，而 `README.md` / `03-phase-plan.md` 明确要求 Phase 4 启动时创建 `BL-010` 子计划；因此应先补 Phase 入口，再写详细 subplan。
