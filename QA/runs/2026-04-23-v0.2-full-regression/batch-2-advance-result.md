...
| C-03 | 进阶一局结算与星级进度 | 完成一局进阶后进入专属 summary，显示 Hearts 投入与星级进度。 | 在 AdvanceSelect 开始基础计算进阶，并用正确答案完成整局。 | 练习完成=true；星进度=true；心进度=true；答题统计=true | PASS | artifacts/shots/C-03-advance-summary.png |
