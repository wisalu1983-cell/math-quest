...
| 版本 | 状态 | 入口 |
|---|---|---|
| **v0.2** | 🟡 开发中（Phase 1~4 完成） · 当前版本 | [v0.2/](./v0.2/) |
...
| 文件 | 内容 | 状态 |
|---|---|---|
| [v0.2/README.md](./v0.2/README.md) | 主线 README（父计划入口）| 🟡 进行中（Phase 1~4 完成，Phase 5 待启动） |
...
| [v0.2/phases/phase-5.md](./v0.2/phases/phase-5.md) | Phase 5 · 历史答题记录 | ⬜ 待启动（Phase 1 已完成，可立即启动） |
