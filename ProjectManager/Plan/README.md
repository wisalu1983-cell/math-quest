...
| 版本 | 状态 | 入口 |
|---|---|---|
| **v0.3** | 🟡 进行中（Phase 1/2 完成，Phase 3 预研已收口） | [v0.3/](./v0.3/) |
...
| 文件 | 内容 | 状态 |
|---|---|---|
| [v0.3/README.md](./v0.3/README.md) | 主线 README（版本入口） | 🟡 进行中（Phase 1/2 完成，Phase 3 预研已收口） |
...
| [v0.3/phases/phase-3.md](./v0.3/phases/phase-3.md) | Phase 3 · UI + 验收 | 📋 预研已收口，待开发文档 |
