...
| 文件 | 内容 | 状态 |
|---|---|---|
| [v0.3/README.md](./v0.3/README.md) | 主线 README（版本入口） | 📋 当前版本（待开工） |
| [v0.3/implementation-plan.md](./v0.3/implementation-plan.md) | 实施计划（Task / 文件清单 / 验收） | ✅ 设计完成 |
| [v0.3/phases/phase-1.md](./v0.3/phases/phase-1.md) | Phase 1 · 基建 + 认证 | ⬜ 待开始 |
| [v0.3/phases/phase-2.md](./v0.3/phases/phase-2.md) | Phase 2 · 同步引擎 | ⬜ 待开始 |
| [v0.3/phases/phase-3.md](./v0.3/phases/phase-3.md) | Phase 3 · UI + 验收 | ⬜ 待开始 |
