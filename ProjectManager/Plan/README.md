...
| [v0.2/phases/phase-1.md](./v0.2/phases/phase-1.md) | Phase 1 · 效率基建 + 低成本修复 | 🟡 进行中 |
| [v0.2/subplans/2026-04-20-dev-tool-panel.md](./v0.2/subplans/2026-04-20-dev-tool-panel.md) | `v0.2-1-1` · F3 开发者工具栏（子计划）| 🟡 进行中（方案已审核，进入实施） |
| [v0.2/phases/phase-2.md](./v0.2/phases/phase-2.md) | Phase 2 · 三项合并短诊断 | ⬜ 待启动（前置：Phase 1 完成）|
| [v0.2/phases/phase-3.md](./v0.2/phases/phase-3.md) | Phase 3 · 诊断结论执行 | ⬜ 占位（Phase 2 诊断报告后充实）|
| [v0.2/phases/phase-4.md](./v0.2/phases/phase-4.md) | Phase 4 · 题型教育设计重梳理 | ⬜ 待启动（4-1 可与 Phase 1/2 并行）|
