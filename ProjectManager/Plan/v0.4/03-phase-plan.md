...
| Phase 2 | A04/A06 降阶并入 A07 | 玩家题型入口收敛、A07 知识点 lane、保留原 A07 低档应用、存档/段位/进阶兼容 | 读 A04/A06/A07 规格、星级/段位规格、存档迁移原则 | A04/A06 不再玩家可见；A07 lane 覆盖原子题型；原 A07 低档应用不丢失；test/build/QA 通过 | ✅ 已完成 |
