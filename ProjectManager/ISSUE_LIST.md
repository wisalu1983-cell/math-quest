...
> 最后更新：2026-04-20（v0.1 收口，已关闭 issue 统一搬至 `Plan/v0.1/issues-closed.md`；`ISSUE-059` 迁入 `Backlog.md`）
> 当前版本：**v0.2**（用户反馈驱动主线 —— 见 `Plan/v0.2/`）
...
|---|---|---|
| 0 | —— | v0.2 主线尚未开始，问题逐步识别中 |

> v0.2 主线 Plan 详见 [Plan/v0.2/README.md](Plan/v0.2/README.md)；主线的执行节奏与候选问题清单以该目录内文档为准。

---

## 开放问题清单

（当前无 v0.2 阶段已立案的 bug / 欠账）
