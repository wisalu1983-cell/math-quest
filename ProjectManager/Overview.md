...
> 最后更新：2026-04-28（v0.5 Phase 2 过滤规则已确认）
...
| 阶段 | 版本 | 状态 | 入口 |
|---|---|---|---|
| **当前版本** | **v0.5** | 🟡 Phase 2 进行中（`BL-009` 过滤规则已确认，下一步实现生成器规则与测试） | [Plan/v0.5/](Plan/v0.5/) |
...
- 🟡 Phase 2 已启动：`BL-009` 竖式题样本质量诊断与过滤规则子计划已创建，固定 seed 初次抽样诊断已完成，过滤规则已确认。入口见 [`Plan/v0.5/subplans/2026-04-28-v05-phase2-BL-009-竖式题样本质量诊断与过滤规则.md`](Plan/v0.5/subplans/2026-04-28-v05-phase2-BL-009-竖式题样本质量诊断与过滤规则.md)
...
- 当前 Phase 2 `BL-009` 样本质量诊断：[Plan/v0.5/subplans/2026-04-28-v05-phase2-BL-009-竖式题样本质量诊断与过滤规则.md](Plan/v0.5/subplans/2026-04-28-v05-phase2-BL-009-竖式题样本质量诊断与过滤规则.md)
