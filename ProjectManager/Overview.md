...
> 最后更新：2026-04-26（v0.4 Phase 4 设计已确认，待实施）
...
| 阶段 | 版本 | 状态 | 入口 |
|---|---|---|---|
| **当前版本** | **v0.4** | ✅ Phase 1 / Phase 2 / Phase 3 已完成；Phase 4 设计已确认，待实施 | [Plan/v0.4/](Plan/v0.4/) |
...
- ✅ 当前版本开放 issue 数为 0
- 🟡 Phase 4 设计已确认：进位/退位格三档规则采用策略判定器方案；低档过程错不通过，中档只在统一结果 UI 给当前题过程提示，高档不显示过程格；compare tip 需重跑补证。入口见 [`Plan/v0.4/subplans/2026-04-26-phase4-进位退位格规则与compare-tip补证.md`](Plan/v0.4/subplans/2026-04-26-phase4-进位退位格规则与compare-tip补证.md)
- 📋 剩余待决策项：Phase 5 是否保留在 v0.4
...
**下一步**：按 Phase 4 子计划实施 `BL-005.2` 进位/退位格三档规则与 `BL-003` compare tip 补证；另行确认 `Phase 5` 去留。
