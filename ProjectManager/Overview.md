...
> 最后更新：2026-04-25（v0.4 Phase 2 题型 IA 方案已定）
...
| 阶段 | 版本 | 状态 | 入口 |
|---|---|---|---|
| **当前版本** | **v0.4** | 🟡 Phase 1 已完成；Phase 2 题型 IA 方案已定，待实施 | [Plan/v0.4/](Plan/v0.4/) |
...
**下一步**：实施 Phase 2 A04/A06 断联并入 A07；随后进入 Phase 3 题目质量与生成器诊断，并另行确认 `BL-005.2` 进位格三档规则与 `Phase 5` 去留。
