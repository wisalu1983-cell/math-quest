...
> 最后更新：2026-04-23（Phase 5 收口：F2 历史答题记录完成，同步主线/索引状态）
...
| 阶段 | 版本 | 状态 | 入口 |
|---|---|---|---|
| **当前版本** | **v0.2** | 🟡 进行中（Phase 1~5 已完成，待 v0.2 收口） | [Plan/v0.2/](Plan/v0.2/) |
...
- ✅ **Phase 5 全部完成**（2026-04-23）：
  - ✅ **`v0.2-5-1` F2 历史答题记录（本地版）** 完成：`mq_history` 数据层、`endSession` / `abandonSession` 双路径写入、记录首页合并、逐题详情页全部落地
  - 自动化验证：vitest 538/538；构建通过
  - 子计划：[`Plan/v0.2/subplans/2026-04-22-5-1-历史答题记录.md`](Plan/v0.2/subplans/2026-04-22-5-1-历史答题记录.md)

**下一步**：执行 v0.2 收口：回写版本快照、同步版本轴状态，并确定下一轮主线。
