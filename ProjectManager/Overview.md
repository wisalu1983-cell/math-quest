...
> 最后更新：2026-04-25（v0.4 Phase 3 题目质量预研已收口；实施待 Phase 2）
...
| 阶段 | 版本 | 状态 | 入口 |
|---|---|---|---|
| **当前版本** | **v0.4** | 🟡 Phase 1 已完成；Phase 2 题型 IA 方案已定待实施；Phase 3 预研已收口 | [Plan/v0.4/](Plan/v0.4/) |
...
- 🟡 Phase 2 方案已定：A04「运算律」/ A06「括号变换」取消玩家独立入口并从新主链路断联；相关能力迁入 A07「简便计算」低档知识点 lane
- ✅ Phase 3 预研已收口：入口见 [`Plan/v0.4/phases/phase-3-research.md`](Plan/v0.4/phases/phase-3-research.md)；当前代码抽样确认 A03 第四关缺少 `2位数 × 2位数` 桥接、A03 进阶 3★ 仍有小规模短除样本、重复题根因是有限模板池 + 无 session 去重；实施前需 Phase 2 后复跑
- ✅ 当前版本开放 issue 数为 0
...
**下一步**：实施 Phase 2 A04/A06 断联并入 A07；随后按 Phase 3 预研口径复跑题目质量抽样并创建实施子计划，另行确认 `BL-005.2` 进位格三档规则与 `Phase 5` 去留。
